...
def split_pos(tokenzied_path, idx=0):
...
def integrate_pos(data_path, pos_path):
    with open(data_path, 'r') as f_data:
        with open(pos_path, 'r') as f_pos:
            with open(data_path[:-4] + '_pos.txt', 'w') as f_new:
...
if __name__ == "__main__":
    ...
    # split_pos('processed/tokenized.txt', 1)
    ...
    integrate_pos('final_tag_3.txt', 'pos.txt')
